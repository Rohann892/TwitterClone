        ...
        <div className="w-full border border-gray-200 rounded-lg px-4 py-2 space-y-3 bg-gray-200/20">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex justify-between">
              <div className="flex">
                ...
                <div className="flex flex-col ml-1">
                  <h2 className="font-bold text-sm">Tomato</h2>
                  <p className="text-gray-400 text-xs">@neembo_pani131</p>
                </div>
              </div>
              <div>
            ...
            <div className="flex justify-between">
              ...
              <div>
                <button className="px-2 py-1 bg-black rounded-full text-white font-md">
                  Follow
                </button>
              </div>
            </div>
